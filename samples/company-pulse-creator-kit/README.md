# Company Pulse - Creator Kit

## Summary

This is a an App like "Company Pulse" app's sample by Microsoft (you can create it by "Start from template" section when you creating new Power App) but this one using standard and Creator Kit controls.
...
![Preview](assets/company-pulse-creatorkit.gif)
...
* Filter: Formula is used inside "Items" property of gallery control.
* Controls from **Creator Kit**:
  - Auto Width Label - used to show Title
  - Elevations - Used inside standard gallery control to show post
  - Tag List - Used inside standard gallery control to show categories of post
...
![Experimental Features](https://img.shields.io/badge/Experimental%20Features-No-green.svg "Does not use experimental features")
...
Solution|Author(s)
--------|---------
Company Pulse - Creator Kit | [Angelo Gulisano](https://github.com/angelogulisano) ([@angelog1908](https://twitter.com/angelog1908))

## Version history

Version|Date|Comments
-------|----|--------
1.0|February 08, 2023|Initial release
...
No configuration is needed to use this sample.

## Data Sources

No datasources needed. List of post are get from rss feed or my personal blog.

## Minimal Path to Awesome

* [Download](./solution/Company Pulse - Creator Kit.msapp) the `.msapp` from the `solution` folder
