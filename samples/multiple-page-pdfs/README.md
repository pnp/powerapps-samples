...
This app showcases how you can use the new PDF()-function to create pixel perfect single and multiple page PDFs.
...
Solution|Author(s)
--------|---------
multiple page PDFs | [Robin Rosengrün](https://github.com/PowerRobin) ([@power_r2](https://twitter.com/power_r2))

## Version history

Version|Date|Comments
-------|----|--------
1.0|October 21st, 2022|Initial release
