...
![picture of the sample](assets/TicTacToeGame.gif)
![picture of the sample](assets/game-screen.png)
![picture of the sample](assets/winner-screen.png)
...
Solution|Author(s)
--------|---------
Tic Tac Toe | [Angelo Gulisano](https://github.com/angelogulisano) ([@yourtwitterhandle](https://twitter.com/angelog1908))
